...
function main(event) {
    const search_approach_elem = document.getElementById("search-approach");

    if (search_approach_elem !== null) {
        search_approach_elem.addEventListener("click", function (event) {
